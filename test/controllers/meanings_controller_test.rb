...
class MeaningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meaning" do
    assert_difference('Meaning.count') do
      post meanings_url, params: { meaning: { en_meaning: @meaning.en_meaning, kind: @meaning.kind, zh_meaning: @meaning.zh_meaning } }
    end
  ...
  test "should update meaning" do
    patch meaning_url(@meaning), params: { meaning: { en_meaning: @meaning.en_meaning, kind: @meaning.kind, zh_meaning: @meaning.zh_meaning } }
