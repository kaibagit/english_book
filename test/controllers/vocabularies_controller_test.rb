...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post vocabularies_url, params: { vocabulary: { content: @vocabulary.content, soundmark: @vocabulary.soundmark, type: @vocabulary.type } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { content: @vocabulary.content, soundmark: @vocabulary.soundmark, type: @vocabulary.type } }
