class ExamplesController < ApplicationController
  ...
  def new
    @example = Example.new
    @example.meaning = Meaning.find params["meaning_id"]
  end
  ...
  def create
    ...
    respond_to do |format|
      if @example.save
        ...
        format.html { redirect_to @example.meaning, notice: 'Example was successfully created.' }
  ...
  private
    ...
    def example_params
      params.require(:example).permit(:meaning_id, :original, :zh_meaning, :meaning_id)
    end
end
